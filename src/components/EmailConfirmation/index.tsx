            ...
            >
                ...
                <View style={styles.entryContainer} >
                    ...
                    <Text style={styles.headerContent} >
                        Size hesabınızı doğrulamanız için bir kod gönderdik.
                    </Text>
                </View>
                ...
                <View style={{ width: "100%", paddingHorizontal: 22, alignItems: 'center', flex:1, }} >
                    ...
                    <TouchableOpacity style={styles.buttonEnvironment}  onPress={nextScreen}  >

                        <Text style={styles.sendCode}>Hesabımı Doğrula</Text>
